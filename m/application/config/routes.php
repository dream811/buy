...
$route['viewdeliveryState'] = 'Index/viewdeliveryState';
$route['viewdeliveryState/(:num)'] = 'Index/viewdeliveryState/$1';
...
$route["getShopProducts"]='Index/getShopProducts';
...
$route['getpayC'] = "Index/getpayC";
$route['taobao'] = "Index/taobao";
