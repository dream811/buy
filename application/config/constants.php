...
define("FEE_LIST",array("29"=>"main_check","7"=>"detail_check","10"=>"shoemedical","26"=>"tackbae","46"=>"package_protect",	"8"=>"special_package","47"=>"onebacs_package","51"=>"ganyifee","17"=>"wonsanji","54"=>"multibacs","55"=>"volumn_weight","56"=>"mountain_fee","12"=>"sum_delivery",	"23"=>"save_fee","9"=>"multipackage"));
...
define("cRYPT",array(
                'cipher' => 'aes-256',
                'mode' => 'ctr',
                'key' => 'a34aa2432532343234f23e3234c233d'
        ));
