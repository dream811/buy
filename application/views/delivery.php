												...
												<td colspan="3">
													<div class="row">
														<div class="col-md-6 p-right-0">
															한글 <input type="text" name="ADRS_KR" id="ADRS_KR" maxlength="60" class="ipt_type1 w-80 input_txt2" required>
														</div>
													...
													<div class="row my-10">
														<div class="col-md-6 p-right-0">
															영문 <input type="text" name="ADRS_EN" id="ADRS_EN" maxlength="60" class="ipt_type1 w-80 input_txt2" required>
														</div>
													</div>
													<div class="row my-4">
														<div class="col-md-12">
											...
											<tbody>
												<tr class="border">
													...
													<td class="text-right">
														<div class="row">
															<div class="col-md-12">
																<a href="javascript:fnPageCopy2('1','<?= $options ?>');" type="button" class="btn btn-warning btn-sm btn-round">상품복사</a>
																<a href="javascript:fnProPlus('1','<?= $options ?>');" class="btn btn-danger btn-sm btn-round">+상품추가</a>
																<button type="button" class="btn btn-danger btn-sm btn-round" onclick="fnStockTempDel(1)">-상품삭제</button>
															</div>
														</div>
													</td>
												</tr>
											...
											<tbody>
												...
												<tr>
													<th>
														...
														<br><a class="btn-small  btn-secondary btn" href="javascript:openPopupImg(1)" data-img="1"><span>이미지등록</span></a>
													</th>
													<td colspan="3">
														<div class="row my-10">
														...
														<div class="row my-10">
															...
															<div class="col-md-4 p-right-15">
																단가
																<input type="text" class="input_txt2 per20 form-control-custom COST" name="COST" maxlength="10" value="0" title="단가" required onblur="fnNumChiper(this, '2');fnTotalProPrice();">
															</div>
															<div class="col-md-4">
																수량&nbsp;&nbsp;&nbsp;&nbsp;
																<input type="text" class="input_txt2 per20 form-control-custom QTY" name="QTY" maxlength="5" value="1" title="수량" required onblur="fnNumChiper(this, '0');fnTotalProPrice();">
															</div>
														</div>
														<div class="row my-10">
															...
															<div class="col-md-4 p-right-15">
																색상
																<input type="text" class="input_txt2 per20 form-control-custom" name="CLR" id="CLR" maxlength="100" title="색상(영문)">
															</div>
															<div class="col-md-4">
																사이즈
																<input type="text" class="input_txt2 per20 form-control-custom" name="SZ" id="SZ" maxlength="80" title="사이즈">
															</div>
														</div>
														<div class="row my-10">
														...
														<div class="row my-10">
															...
															<div class="col-sm-10">
																<input type="text" class="input_txt2 full form-control" name="IMG_URL" id="IMG_URL" maxlength="500">
															</div>
														</div>
													</td>
												</tr>
