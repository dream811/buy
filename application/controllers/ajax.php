								...
								<td class="text-right">
									<div class="row">
										<div class="col-md-4  mt-7">
											<a href=\'javascript:fnPageCopy2('.$sShopNum.',"'.$t.'");\' type="button" class="btn btn-warning btn-sm w-100">상품복사</a>
										</div>
										<div class="col-md-4  mt-7">
											<a href=\'javascript:fnProPlus('.$sShopNum.',"'.$t.'");\' class="btn btn-success btn-sm w-100">+상품추가</a>
										</div>
										<div class="col-md-4  mt-7">
					...
					<table class="order_write">
						...
						echo '<tr>
								<th>
									...
									<br><a class="btn-small  btn-secondary btn" href="javascript:openPopupImg('.$sShopNum.')" data-img="1"><span>이미지등록</span></a>
								</th>
								<td colspan="3">
							...
							echo 		'</select>
									...
									<div class="row" style="margin-top: 10px">
										...
										<div class="col-md-4">
											<input type="text" class="input_txt2 per40 form-control en_product_name" name="PRO_NM" id="PRO_NM" maxlength="200"  value="" title="상품명" required onblur="javascript:fnValKeyRep( /[^a-zA-z0-9 \,\.\-]/g, this );">
										</div>
									</div>
									<div class="row" style="margin-top: 10px">
			...
			if($sShopNum >30) {echo json_encode(array("c"=>1,"data"=>"상품의 개수는 최대 30개를 넘길수 없습니다."));return;}
				...
				<div class="order_table">
					<table class="order_write">
						...
						$temp.= '<tr>
								<th>
									<p class="goods_img"><img src="'.$child->image.'" width="109" height="128" id="sImgNo'.$sShopNum.'"></p>
									<br><a class="btn-small  btn-secondary btn" href="javascript:openPopupImg('.$sShopNum.')" data-img="1"><span>이미지등록</span></a>
								</th>
								<td colspan="3">
									<div class="row" style="margin-top: 10px">
							...
							$temp .= 		'</select>
									...
									<div class="row" style="margin-top: 10px">
										<label class="col-sm-2">* 상품명(영문)</label>
										<div class="col-md-4">
											<input type="text" class="input_txt2 per40 form-control en_product_name" name="PRO_NM" id="PRO_NM" maxlength="200" title="상품명" required onblur="javascript:fnValKeyRep( /[^a-zA-z0-9 \,\.\-]/g, this );">
										</div>
									</div>
									<div class="row" style="margin-top: 10px">
										<label class="col-sm-2">* 단가</label>
